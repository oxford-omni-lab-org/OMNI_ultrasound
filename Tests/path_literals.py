...
BASE_PATH = Path("Tests/testdata")
TEST_IMAGE_PATH = BASE_PATH / "example_image.nii.gz"
TEST_IMAGE_PATH_MHA = BASE_PATH / "example_image.mha"
TEMP_SAVEPATH = BASE_PATH / "temp"
